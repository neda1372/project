...
$(document).ready(function () {
  ...
  function renderToPachageDropDown(array) {
    for (var i = 0; i < array.length; i++) {
      document
        .querySelector("select#ProductStatusModalInputDropdown")
        .fstdropdown.rebind();
      var html =
        '<option value="' +
        array[i].id +
...
$(document).ready(function () {
  ...
  function renderToPachageDropDown(array) {
    for (var i = 0; i < array.length; i++) {
      document
        .querySelector("select#ProductUnitInputDropdown")
        .fstdropdown.rebind();
      var html =
        '<option value="' +
        array[i].id +
...
//         var dropdownid = $('select#HardnerDropdown option:selected').val();
//         var tableid =$('select#HardnerList').val();
//         box.push(dropdownid, tableid);
//         myfunction();
//     });
//     var box;
//     box = naw Array();
...
$(document).ready(function () {
  $("#btnAddToHardnerList").click(function () {
    // e.preventDefault();
    var HardnerDropdowText = $("select#HardnerDropdown option:selected").text();
    let option = $("select#HardnerDropdown option:selected")[0];
    //
    let selectedOption = packagejson.find((o) => o.id === option.value);
  ...
  function RenderToTable(array) {
    for (var i = 0; i < array.length; i++) {
      ...
      document.querySelector("#HardnerList");
      var html =
        '<tr> <td style="background-color:#E6E6E6; text-align: right; border:2px solid white;">' +
        row +
        "</td>" +
        '<td style="background-color:#E6E6E6; text-align: right; border:2px solid white;">' +
        col1 +
        "</td>" +
        '<td style="background-color:#E6E6E6; text-align:right; border:2px solid white;"></td>' +
        '<td style="background-color:#ff675e;"> <button style="border: none; background: none;"><img src="../DiacoIcon/RecycleBin.svg" style=" width: 20px; height: 20px;"> </button> </td></tr>';
...
$(document).ready(function () {
  ...
  function renderToPachageDropDown(array) {
    for (var i = 0; i < array.length; i++) {
      document
        .querySelector("select#ProductContainerDropdown")
        .fstdropdown.rebind();
      var html =
        '<option value="' +
        array[i].id +
...
$(document).ready(function () {
  $("#btnAddToPackingList").click(function () {
    var ProductContainerText = $(
      "select#ProductContainerDropdown option:selected"
    ).text();
    var PackingWeighttext = $("#PackingWeight").val();
    var themeDropdownText = $(
      "select#lable-themeDropdown option:selected"
    ).text();
    row = row + 1;
...
$(document).ready(function () {
  ...
  function renderToPachageDropDown(array) {
    for (var i = 0; i < array.length; i++) {
      document
        .querySelector("select#ProductLayerTypeDropdown")
        .fstdropdown.rebind();
      var html =
        '<option value="' +
        array[i].id +
...
$(document).ready(function () {
  ...
  function renderToPachageDropDown(array) {
    for (var i = 0; i < array.length; i++) {
      document
        .querySelector("select#ProductStructureDropdown")
        .fstdropdown.rebind();
      var html =
        '<option value="' +
        array[i].id +
...
$(document).ready(function () {
  $("#btnAddToUseFor").click(function () {
    ...
    table.push([
      UseForDropdownText,
      PersianUseForDesctext,
      EnglishUseForDesctext,
    ]);
    RenderToTable(table);
  });
  var table;
...
$(document).ready(function () {
  ...
  function renderToPachageDropDown(array) {
    for (var i = 0; i < array.length; i++) {
      document
        .querySelector("select#SpecificationDropdown")
        .fstdropdown.rebind();
      var html =
        '<option value="' +
        array[i].id +
...
$(document).ready(function () {
  $("#btnAddToSpecification").click(function () {
    var SpecificationDropdownText = $(
      "select#SpecificationDropdown option:selected"
    ).text();
    row = row + 1;
...
$(document).ready(function () {
  $("#btnAddToApplication").click(function () {
    debugger;
    var ApplicationDropdownText = $(
      "select#ApplicationDropdown option:selected"
    ).text();
    var PersianApplicationtext = $("#PersianApplicationDesc").val();
    var EnglishApplicationtext = $("#EnglishApplicationDesc").val();
    row = row + 1;
    table.push([
      ApplicationDropdownText,
      PersianApplicationtext,
      EnglishApplicationtext,
    ]);
    RenderToTable(table);
  });
  var table;
